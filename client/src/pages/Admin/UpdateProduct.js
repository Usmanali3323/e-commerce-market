...
const UpdateProduct = (props) => {
  ...
  //Getting full detail of Product
  ...
  const Updatehandleform = async (e) => {
    try {
      e.preventDefault();
      ...
      await productData.append("photo", photo);
  ...
  const getCategory = async () => {
    try {
      ...
      toast.error("Error in get Category");
          ...
          <div className="row">
            ...
            <div className="col-md-9">
              ...
              <div className="m-3 w-75">
                ...
                <div className="m-3">
                  <button
                    className="btn-primary me-2 btn text"
                    onClick={Updatehandleform}
                  >
                    Update Product
                  </button>
                  <button
                    className="btn-danger ms-2 btn text"
                    onClick={Deletehandleform}
                  >
                    Delete Product
                  </button>
                </div>
